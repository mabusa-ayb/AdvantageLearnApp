...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    scoreMatch: function scoreMatch() {
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c(
      "form",
      {
        attrs: { action: "/score", method: "POST" },
        on: {
          submit: function ($event) {
            $event.preventDefault()
            return _vm.scoreMatch.apply(null, arguments)
          },
        },
      },
      [
        _c("div", { staticClass: "row g-3" }, [
          _c("div", { staticClass: "col" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.form.playerOne,
                  expression: "form.playerOne",
                },
              ],
              ...
              domProps: { value: _vm.form.playerOne },
              on: {
                input: function ($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.form, "playerOne", $event.target.value)
                },
              },
            }),
          ]),
          ...
          _c("div", { staticClass: "col" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.form.playerTwo,
                  expression: "form.playerTwo",
                },
              ],
              staticClass: "form-control",
              attrs: {
              ...
              domProps: { value: _vm.form.playerTwo },
              on: {
                input: function ($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.form, "playerTwo", $event.target.value)
                },
              },
            }),
          ]),
